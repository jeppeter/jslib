...
curl -vvvvv  -o out.json \
--header 'Accept: */*' --header 'Accept-EncKey: kBHIDgu19LPA6iRcLqiLgQ==' \
...
http://webapi.cninfo.com.cn/api/info/p_info3085?scode=300511&sdate=20200101&edata=20240101