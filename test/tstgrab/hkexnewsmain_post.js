...
function createHkexNewsMainPost(options) {
    ...
    hknews.options.ddlTierTwo = '59%2C1%2C7';
    hknews.options.ddlTierTwoGroup = '19%2C5';
    ...
    hknews.make_post_data = function (inputctrl) {
        ...
        postdata += util.format('%s&', hknews.options.txt_today);
        postdata += 'ctl00%24hfStatus=';
        postdata += util.format('%s&', hknews.options.hfStatus);
        postdata += 'ctl00%24hfAlert=';
        postdata += util.format('%s&', hknews.options.hfAlert);

        postdata += 'ctl00%24txt_stock_code=';
        postdata += util.format('%s&', hknews.options.txt_stock_code);
        postdata += 'ctl00%24txt_stock_name=';
        postdata += util.format('%s&', hknews.options.txt_stock_name);
        postdata += 'ctl00%24rdo_SelectDocType=';
        postdata += util.format('%s&', hknews.options.rdo_SelectDocType);
        postdata += 'ctl00%24sel_tier_1=';
        postdata += util.format('%s&', hknews.options.sel_tier_1);
        postdata += 'ctl00%24sel_DocTypePrior2006=';
        postdata += util.format('%s&', hknews.options.sel_DocTypePrior2006);
        postdata += 'ctl00%24sel_tier_2_group=';
        postdata += util.format('%s&', hknews.options.sel_tier_2_group);
        postdata += 'ctl00%24sel_tier_2=';
        postdata += util.format('%s&', hknews.options.sel_tier_2);
        postdata += 'ctl00%24ddlTierTwo=';
        postdata += util.format('%s&', hknews.options.ddlTierTwo);
        postdata += 'ctl00%24ddlTierTwoGroup=';
        postdata += util.format('%s&', hknews.options.ddlTierTwoGroup);
        postdata += 'ctl00%24txtKeyWord=';
        postdata += util.format('%s&', hknews.options.txtKeyWord);
        postdata += 'ctl00%24rdo_SelectDateOfRelease=';
        postdata += util.format('%s&', hknews.options.rdo_SelectDateOfRelease);
        postdata += 'ctl00%24sel_DateOfReleaseFrom_d=';
        postdata += util.format('%s&', hknews.options.sel_DateOfReleaseFrom_d);
        postdata += 'ctl00%24sel_DateOfReleaseFrom_m=';
        postdata += util.format('%s&', hknews.options.sel_DateOfReleaseFrom_m);
        postdata += 'ctl00%24sel_DateOfReleaseFrom_y=';
        postdata += util.format('%s&', hknews.options.sel_DateOfReleaseFrom_y);
        postdata += 'ctl00%24sel_DateOfReleaseTo_d=';
        postdata += util.format('%s&', hknews.options.sel_DateOfReleaseTo_d);
        postdata += 'ctl00%24sel_DateOfReleaseTo_m=';
        postdata += util.format('%s&', hknews.options.sel_DateOfReleaseTo_m);
        postdata += 'ctl00%24sel_DateOfReleaseTo_y=';
        postdata += util.format('%s&', hknews.options.sel_DateOfReleaseTo_y);
        postdata += 'ctl00%24sel_defaultDateRange=';
        postdata += util.format('%s&', hknews.options.sel_defaultDateRange);
        postdata += 'ctl00%24rdo_SelectSortBy=';
        postdata += util.format('%s', hknews.options.rdo_SelectSortBy);
        return postdata;
    };
